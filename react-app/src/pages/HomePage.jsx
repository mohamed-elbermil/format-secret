...
const structuredData = {
  ...
  name: 'FormaSecret',
  description: 'Organisme de formation expert en efficacité professionnelle, management et vente',
...
const orientationSteps = [
  ...
  { label: '3. Présentation du/des parcours personnalisé(s)', duration: '10 min' },
]
      ...
      <section className="hero hero-index">
        <Container className='index'>
          <div className="hero-content">
            ...
            <img src={heroPeople} alt="Apprenants et formateurs" className='people-banner' loading="eager" />
          </div>
        </Container>
      </section>
          ...
          <div className="orientation-steps">
            {orientationSteps.map(({ label, duration }, i) => (
              <div key={i} className="orientation-step">
                ...
                <div className="orientation-step-time"><i className="fa-regular fa-clock"></i> {duration}</div>
              </div>
            ))}
          </div>
          ...
          <div className="qualiopi-content">
            <div className="qualiopi-logo">
              <a href="https://certifopac.fr/qualiopi/certification/verification/?siren=911922540" target="_blank" rel="noopener noreferrer">
                <img src="/assets/images/logo-qualiopi-valide-400x179.png" alt="Logo Certification Qualiopi" loading="lazy" />
              </a>
            </div>
