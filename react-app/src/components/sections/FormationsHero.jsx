    ...
    <section className="fh-section" aria-label="Bannière page Formations">
      ...
      <div className="fh-inner container">
        ...
        <nav className="fh-breadcrumb" aria-label="Fil d'Ariane">
          ...
          <span className="fh-breadcrumb-current" aria-current="page">
            Formations
          </span>
        </nav>
        ...
        <p className="fh-subtitle">
          ...
          management, efficacité professionnelle et vente - animés par des
          experts praticiens.
        </p>
      ...
      <div className="fh-wave" aria-hidden="true">
        ...
        >
          <path
            d="M0,30 C480,60 960,0 1440,30 L1440,50 L0,50 Z"
            fill="var(--clr-cream)"
          />
        </svg>
      </div>
