...
const faqs = [
  ...
  },
  {
    ...
    a: 'Absolument. Nos formations intra-entreprise sont conçues pour des groupes de 4 à 15 personnes. Nous nous déplaçons dans vos locaux ou proposons un format en visioconférence selon vos besoins.',
  },
  {
    ...
    <section className="faq-section" aria-labelledby="faq-title">
      <Container>
        ...
        <div className="faq-footer">
          <p className="faq-footer__text">Une question qui n'est pas listée ici ?</p>
