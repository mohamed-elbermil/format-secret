      ...
      <Container>
        ...
        <div className="mod-header">
          ...
          <p className="mod-header__sub">
            Quel que soit votre contexte — individuel, équipe ou national — nous avons
            la formule qui correspond à vos besoins et à votre budget.
          </p>
        </div>

        <div className="mod-grid">
          {modalites.map(({ Icon, accentColor, label, title, desc, details }, i) => (
            <article key={i} className="mod-card" style={{ '--mod-accent': accentColor }}>
              ...
              <ul className="mod-card__list" aria-label={`Détails — ${title}`}>
                {details.map((d, j) => (
